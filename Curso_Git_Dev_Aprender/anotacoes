...
o github tem mudado para main o nome da branch principal,é importante que isso seja conversado com os integrantes da empresa caso ainda estejam adotando o modo antigo(master)

comando para mudar para main = git branch - M 'main'
...
git cd - serve para abrir uma pasta, para utilizar basta digitar cd + nome da pasta aonde está situado o conteúdo
